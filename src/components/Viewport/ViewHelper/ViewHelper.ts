...
class ViewHelper extends THREE.Object3D {
	...
	constructor( editorCamera: THREE.Camera, dom: HTMLCanvasElement ) {
		...
		const interactiveObjects: THREE.Object3D<THREE.Event>[] | THREE.Sprite[] = [];
		...
		this.handleClick = function ( event: MouseEvent ) {
		...
		function prepareAnimationData( object: THREE.Object3D<THREE.Event>, focusPoint: THREE.Vector3 ) {
		...
		function getSpriteMaterial( color: THREE.Color, text:any = null ) {
